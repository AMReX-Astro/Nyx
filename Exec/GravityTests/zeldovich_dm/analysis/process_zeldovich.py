...
for pf_path in pf_paths:
    ...
    print ""
    print "Processing pf%05d" % plt_num
    print "=================="
    print ""
    ...
    print "Max velocity is %.2e km/s." % max_v_along
    print ""
    ...
    fig.savefig("velocity_along_%05d.png" % plt_num)
    plt.close()
    ...
    ax.text(0.83, 0.92, r"$z_c = %.2f$" % caustic_z, transform=ax.transAxes, fontsize=16)
    ax.text(0.83, 0.85, r"$z = %.2f$" % current_z, transform=ax.transAxes, fontsize=16)

    fig.savefig("phase_space_%05d.png" % plt_num)
    plt.close()
    ...
    ax.text(16, 0.0, 20, r"$z_c = %.2f$" % caustic_z)
    ax.text(16, 0.0, 18, r"$z = %.2f$" % current_z)
    ax.set_xlim3d(0, box_length)
    ax.set_ylim3d(0, box_length)
    ax.set_zlim3d(0, box_length)

    fig.savefig("positions_%05d.png" % plt_num)
    plt.close()
