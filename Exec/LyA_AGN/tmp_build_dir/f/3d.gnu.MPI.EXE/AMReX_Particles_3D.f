...
! :: ----------------------------------------------------------
! ::
      subroutine part_summassdown(crse,c_l1,c_l2,c_l3,c_h1,c_h2,c_h3,fin
     &e,f_l1,f_l2,f_l3,f_h1,f_h2,f_h3,lo,hi,lrat)
      implicit none
...
! :: ----------------------------------------------------------
! ::
      subroutine part_summassup(crse,c_l1,c_l2,c_l3,c_h1,c_h2,c_h3,fine,
     &f_l1,f_l2,f_l3,f_h1,f_h2,f_h3,lo,hi,lrat)
      implicit none
            ...
            do joff = 0, lraty-1
               do jc = lo(2), hi(2)
                  ...
                  do ioff = 0, lratx-1
                     do ic = lo(1), hi(1)
                        i = ic*lratx + ioff
                        fine(i,j,k) = fine(i,j,k) + volfrac*crse(ic,jc,k
     &c)
                     enddo
                  enddo
               enddo
...
! :: ----------------------------------------------------------
! ::
      subroutine part_sumdensup(crse,c_l1,c_l2,c_l3,c_h1,c_h2,c_h3,fine,
     &f_l1,f_l2,f_l3,f_h1,f_h2,f_h3,lo,hi,lrat)
      implicit none
