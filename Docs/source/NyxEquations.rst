...
and :math:`\Ub` is the proper peculiar baryonic velocity.
...
.. math::
   ...
   + \rho_b \gb 
   + {\bf S}_{\rho \Ub}
   - \dot{a} \rho_b \Ub \right) \enskip , \end{aligned}
...
.. math::
   ...
   -             \nabla p 
   +             \rho_b \gb 
   +             {\bf S}_{\rho \Ub} \enskip , \end{aligned}
...
:math:`{\bf S}_{\rho \Ub}` represents any external forcing terms.
...
.. math::
   ...
   - \dot{a} ( 3 (\gamma - 1) \rho_b e + \rho_b ( \Ub \cdot \Ub) ) \right] \enskip . \end{aligned}
...
.. math::
   ...
   +  \rho_b \Ub \cdot \gb 
   +  S_{\rho E}  
   +  \dot{a} ( \; ( 2 - 3 (\gamma - 1) ) \; \rho_b e ) \right] \enskip . \end{aligned}

Here :math:`E = e + \Ub \cdot \Ub / 2` is the total energy per unit mass,
where :math:`e` is the specific internal energy.
:math:`S_{\rho E} = S_{\rho e} + \Ub \cdot {\bf S}_{\rho \Ub}`
...
.. math::
   ...
   + S_{\rho e}  \right] \enskip . \end{aligned}
...
In order to compute the fluxes on faces, we trace :math:`\rho, \Ub, \rho e` and :math:`p` to the faces.
...
.. math::
   ...
   - \dot{a} \Ub \right) \enskip .\end{aligned}
...
.. math::
   ...
   + a^2(\Sigma - \rho_b \varepsilon)\enskip .\end{aligned}
