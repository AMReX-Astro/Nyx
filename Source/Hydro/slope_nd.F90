...
contains
  ...
  AMREX_CUDA_FORT_DEVICE subroutine uslope(lo, hi, idir, &
    ...
    use meth_params_module, only: QVAR, iorder
    ...
    real(rt), intent(inout) :: dq(qpd_lo(1):qpd_hi(1),qpd_lo(2):qpd_hi(2),qpd_lo(3):qpd_hi(3),QVAR)
  ...
  AMREX_CUDA_FORT_DEVICE subroutine pslope(lo, hi, idir, &
    ...
    use meth_params_module, only : QRHO, QPRES, QU, QV, QW, QVAR, NQSRC, iorder
