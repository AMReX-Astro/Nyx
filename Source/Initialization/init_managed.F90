...
allocate(ppm_type,use_flattening,use_const_species,inhomo_reion,grav_source_type)
...
deallocate(ppm_type,use_flattening,&
     use_const_species,inhomo_reion,grav_source_type)
...
if(allocated(ggh0_2)) deallocate(ggh0_2)
if(allocated(gghe0_2)) deallocate(gghe0_2)
if(allocated(gghep_2)) deallocate(gghep_2)
if(allocated(eh0_2)) deallocate(eh0_2)
if(allocated(ehe0_2)) deallocate(ehe0_2)
if(allocated(ehep_2)) deallocate(ehep_2)
