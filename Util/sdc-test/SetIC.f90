...
subroutine SetInternalEnergy_mfab(mf, lo, hi) bind(C, name="FSetInternalEnergy_mfab")
  ...
  do k=lo(3),hi(3)
     do j=lo(2),hi(2)
        do i=lo(1),hi(1)
           ! Set initial conditions for the ODE for this cell.
           mf(i,j,k) = real(6.226414794921875E+02, c_double)

        end do
     end do
  end do

end subroutine SetInternalEnergy_mfab
