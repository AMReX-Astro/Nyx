...
!  attributes(managed) :: NGDNV, GDPRES, GDU, GDV, GDW, QVAR
 ...
 attributes(managed) :: ppm_type,ppm_reference,ppm_flatten_before_integrals,use_flattening,use_const_species,normalize_species,inhomo_reion,grav_source_type
